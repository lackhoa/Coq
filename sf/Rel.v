...
(** Show that the [total_relation] defined in earlier is not a partial
    function. *)
Theorem total_rel_not_partial_function : 
  ~ (partial_function total_relation).
Proof. unfold partial_function. intro.
assert (0 = 1) as Nonsense.
...
Theorem empty_rel_partial_function :
...
Theorem le_not_symmetric :
  ~ (symmetric le).
Proof. unfold symmetric; intro; intros.
assert (1 <= 0) as Nonsense.
{ apply H. auto. } inversion Nonsense. Qed.
(** [] *)
...
Theorem le_antisymmetric :
  antisymmetric le.
Proof. unfold antisymmetric. intros. omega. Qed.
(** [] *)
...
- apply IHclos_refl_trans_1n in H1. apply rt1n_trans with y; auto. Qed. 
...
- induction H. + apply rsc_R; auto. + apply rt1n_refl.
+ apply rsc_trans with y; auto.
- induction H. + apply rt_refl. + apply rt_trans with y.
* apply rt_step; auto. * auto. Qed. 
(** [] *)
